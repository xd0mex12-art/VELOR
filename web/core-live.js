// ===== VELOR — ЖИВОЕ ЯДРО v12 «Разум» (Dala / OLED) =====
//
// Живёт ровно на двух экранах: «Обзор» и «Спросить». Поле летающих частиц,
// которое раньше лежало в этом же файле и включалось на двадцати страницах,
// удалено — оно ничего не сообщало и шло поверх текста. Ядро осталось, потому
// что оно говорит о состоянии сотрудника, а не украшает фон.
