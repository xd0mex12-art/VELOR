...
(function () {
  var SECTIONS = [
    ...
    { t: 'Реестр', h: 'clients.html', kids: [
      ...
      // Закупки стоят рядом с финансами, а не в разборе VELOR: это те же
      // расходы, просто со стороны «кому и почём», и владелец идёт сюда
      // из того же вопроса о деньгах.
      { t: 'Закупки',        h: 'purchases.html' },
