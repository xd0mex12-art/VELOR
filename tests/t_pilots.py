...
# Админки как отдельной страницы больше нет — её содержимое переехало
# в кабинет владельца, обычной страницей продукта.
adm = pathlib.Path("web/owner.html").read_text(encoding="utf-8")
