...
_STRONG = [
    ...
    # «Возьмётесь?» — прямая просьба сделать работу, а не вопрос о ней.
    r"возьм[её]тесь|бер[её]тесь",
    # «Сколько будет X» без глагола «стоит»: самая частая форма вопроса о цене.
